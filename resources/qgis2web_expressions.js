...
function exp_Biomes_5rule0_eval_expression(context) {
    // Biome = 'Mountain'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Biome')  == 'Mountain');
    } else {
        return (feature.get('Biome')  == 'Mountain');
    }
}
...
function exp_Roads_6rule0_eval_expression(context) {
    // status = 'completed' AND priority = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('status')  == 'completed') && (feature.get('priority')  == 1));
    } else {
        return ((feature.get('status')  == 'completed') && (feature.get('priority')  == 1));
    }
}
...
function exp_Roads_6rule1_eval_expression(context) {
    // status = 'completed' AND priority = 2

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('status')  == 'completed') && (feature.get('priority')  == 2));
    } else {
        return ((feature.get('status')  == 'completed') && (feature.get('priority')  == 2));
    }
}
...
function exp_Roads_6rule2_eval_expression(context) {
    // status = 'proposed'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('status')  == 'proposed');
    } else {
        return (feature.get('status')  == 'proposed');
    }
}